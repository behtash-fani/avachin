#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Responsive composition for the Persian Avachin desktop UI."""
...
from tools.persian_ui_alias_v2 import AliasPageV2Mixin
from tools.persian_ui_base_v2 import ResponsivePersianUIBase
from tools.persian_ui_common import PALETTE, choose_persian_font, clean_text
from tools.persian_ui_history_v2 import HistoryPageV2Mixin
from tools.persian_ui_home_v2 import HomePageV2Mixin
from tools.persian_ui_review_v2 import ReviewPageV2Mixin
from tools.version import AVACHIN_VERSION


class PersianMaterialAppV2(
    HomePageV2Mixin,
    ReviewPageV2Mixin,
    AliasPageV2Mixin,
    HistoryPageV2Mixin,
    ResponsivePersianUIBase,
):
    def __init__(
        self,
        root: tk.Tk,
